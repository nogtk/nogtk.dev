...
const Footer = () => {
  return (
    <footer className="bg-sol-base02 dark:bg-sol-base03 text-sol-base0 mt-12">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-8 text-center">
        <p>&copy; 2025 nogtk.dev. All rights reserved.</p>
        <p className="text-sm mt-1">Designed with <span className="text-sol-red">&hearts;</span> using Tailwind CSS.</p>
        <div className="mt-4 flex justify-center space-x-4">
          <a href="#" className="text-sol-base1 dark:text-sol-base0 hover:text-sol-base3 transition-colors">
